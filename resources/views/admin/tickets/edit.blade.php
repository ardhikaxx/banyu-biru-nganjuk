                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="price" value="{{ old('price', $ticket->price) }}" placeholder="50000" required min="0" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                </div>
                                @error('price')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" name="quota_per_day" value="{{ old('quota_per_day', $ticket->quota_per_day) }}" placeholder="100" required min="1" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
