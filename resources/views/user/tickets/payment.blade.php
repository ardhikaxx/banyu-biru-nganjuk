...
<div class="page-hero mb-4" data-aos="fade-down">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h3 class="mb-1"><i class="fas fa-wallet me-2"></i>Pembayaran Tiket</h3>
...
<div class="card" data-aos="fade-up" data-aos-delay="120">
    ...
    <div class="card-body">
        <form action="{{ route('user.tickets.upload', $order->order_code) }}" method="POST" enctype="multipart/form-data">
            @csrf
